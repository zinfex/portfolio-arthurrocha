              ...
              <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-4 md:p-5">
                ...
                <div className="space-y-3 text-md text-slate-300">
                  <div className="flex justify-around mb-5 mt-4">
                    <a href="https://wa.link/vwljgz" target="_blank" className="bg-[#000000] px-5 py-2 flex items-center gap-3 rounded-xl border border-transparent hover:border-sky-500/70 hover:bg-slate-900/90 transition-colors">
                    ...
                    <a href="https://wa.link/vwljgz" target="_blank" className="bg-[#000000] px-5 py-2 flex items-center gap-3 rounded-xl border border-transparent hover:border-sky-500/70 hover:bg-slate-900/90 transition-colors">
                        ...
                        <div className="relative">
                            <span className="block text-xs uppercase tracking-wide text-slate-400">E-mail</span>
                ...
                <iframe className="mapa" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d127394.47751649197!2d-38.602016250281835!3d-3.7933106885418737!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x7c74c3f464c783f%3A0x4661c60a0c6b37ca!2sFortaleza%20-%20CE!5e0!3m2!1spt-BR!2sbr!4v1773706413552!5m2!1spt-BR!2sbr" width="100%" height="350" loading="lazy"></iframe>
              </div>
            </div>
